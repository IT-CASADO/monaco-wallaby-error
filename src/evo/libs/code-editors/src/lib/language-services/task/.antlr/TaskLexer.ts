...
export class TaskLexer extends Lexer {
	...
	public static readonly ruleNames: string[] = ['ADD', 'TASK', 'COMPLETE', 'STRING', 'EOL', 'WS'];
	...
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(
		TaskLexer._LITERAL_NAMES,
		TaskLexer._SYMBOLIC_NAMES,
		[],
	);
	...
	public get vocabulary(): Vocabulary {
		return TaskLexer.VOCABULARY;
	}
	// tslint:enable:no-trailing-whitespace

	constructor(input: CharStream) {
		super(input);
		this._interp = new LexerATNSimulator(TaskLexer._ATN, this);
	}
	...
	public get ruleNames(): string[] {
		return TaskLexer.ruleNames;
	}

	// @Override
	public override get serializedATN(): string {
		return TaskLexer._serializedATN;
	}

	// @Override
	public get channelNames(): string[] {
		return TaskLexer.channelNames;
	}

	// @Override
	public get modeNames(): string[] {
		return TaskLexer.modeNames;
	}
	...
	public static readonly _serializedATN: string =
		...
		'F\x02\x02\x12\x04\x03\x02\x02\x02\x13\x14\x07V\x02\x02\x14\x15\x07C\x02' +
		'\x02\x15\x16\x07U\x02\x02\x16\x17\x07M\x02\x02\x17\x06\x03\x02\x02\x02' +
	...
	public static get _ATN(): ATN {
		if (!TaskLexer.__ATN) {
			TaskLexer.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(TaskLexer._serializedATN));
		}

		return TaskLexer.__ATN;
	}
}
